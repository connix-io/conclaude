...
fn test_parse_settings_without_hooks_field() {
    ...
    assert!(
        result.is_ok(),
        "Should successfully parse settings without hooks field"
    );
...
fn test_parse_settings_with_hooks_field() {
    ...
    assert!(
        result.is_ok(),
        "Should successfully parse settings with hooks field"
    );
...
fn test_parse_real_world_settings() {
    ...
    assert!(
        result.is_ok(),
        "Should successfully parse real-world settings without hooks"
    );
