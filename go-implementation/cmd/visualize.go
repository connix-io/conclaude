...
func init() {
	visualizeCmd.Flags().StringVarP(&visualizeRule, "rule", "r", "", "The specific rule to visualize (e.g., \"uneditableFiles\", \"preventRootAdditions\")")
	visualizeCmd.Flags().BoolVar(&visualizeShowMatches, "show-matches", false, "Show files that match the rule")
}
