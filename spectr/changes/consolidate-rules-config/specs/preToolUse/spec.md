# preToolUse File Protection Configuration Specification

## Purpose
Define consolidated file protection validation rules in the `preToolUse` configuration section, including prevention of root-level file additions and protection of sensitive files from modification.
