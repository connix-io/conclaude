...
Defines how conclaude validates and enforces file protection rules, including uneditable file patterns with optional custom messages, pattern matching behavior, and error handling for blocked operations.
