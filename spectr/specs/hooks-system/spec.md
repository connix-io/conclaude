...
Defines the hook payload types and enum structure for handling Claude Code hook events, including PermissionRequest hooks for tool permission decisions.
