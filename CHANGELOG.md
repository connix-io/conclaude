...
- Fixed `preventAdditions` setting in `preToolUse` hook which was non-functional - now correctly blocks Write tool operations matching configured glob patterns
